...
const IcoStock = () => (<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M20 7h-4V3H8v4H4v14h16Z"/><path d="M8 7V3h8v4"/><path d="M4 12h16"/><path d="M4 17h16"/></svg>);
